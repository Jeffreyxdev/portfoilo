  ...
  return (
    <section className="mx-[30px] lg:mx-[76px] lg:mt-[150px]">
      <div className="flex flex-col items-center gap-[35px] md:gap-[25px]">
        <h3
          className={`font-medium text-[#000] text-lg text-center max-w-[320px] md:max-w-[992px] md:text-[25px] mmd:leading-[37.5px]`}
        >
      ...
      >
        <div className="flex flex-col items-center gap-[10px]">
          <div className="rounded-2xl pr-[1px] pt-[1px] max-w-[75px] max-h-[75px]">
            <MailIcon
            fill={`#000`}
